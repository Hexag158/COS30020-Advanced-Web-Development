...
if (($_POST["item_name"]) && isset($_POST["quantity"])) { // check if both form data exists
    $item = $_POST["item_name"]; // obtain the form item data
    ...
    if (file_exists($filename)) { // check if file exists for reading
        ...
        while (! feof (_(7)_)) { // loop while not end of file
